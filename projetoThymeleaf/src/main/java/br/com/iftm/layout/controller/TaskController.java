package br.com.iftm.layout.controller;
...
import br.com.iftm.layout.model.Task;
...
public class TaskController {
  ...
  public String create(Task task) {
    ...
    if (task.getId() != null) {
      ...
      tasks.add(new Task(id, task.getName(), task.getCpf(), task.getEmail()));
    }
...
public String delete(@PathVariable("id") Long id) {
    Task taskToRemove = tasks.stream().filter(task -> id.equals(task.getId())).findFirst().orElse(null);
